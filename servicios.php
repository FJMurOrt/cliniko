...
<section class="seccion-servicios py-5">
    <div class="contenedor">
        <h1 class="titulo-principal text-center" style="color: #f0cb93ff;">Nuestros servicios</h1>
...
<hr></hr>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center" style = "background-color: #FFF8E1">
                    <div class="card-body">
                        <img src="img/cita_medica.png" alt="cita_medica" style="max-width: 100%; height: auto;">

                        <h5 class="card-titulo" style="color: #333333;">Gestión de citas</h5>
                        <p class="card-text">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center" style = "background-color: #FFF8E1">
                    <div class="card-body">
                        ...
                        <img src="img/historiales_medicos.png" alt="historiales_apilados" style="max-width: 100%; height: auto;">

                        <h5 class="card-titulo" style="color: #333333;">Historiales médicos</h5>
                        <p class="card-text">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center" style = "background-color: #FFF8E1">
                    <img src="img/notificacion_correo.png" alt="correo_electrónico" style="max-width: 100%; height: auto;">

                    <div class="card-body">
                        <h5 class="card-titulo" style="color: #333333;">Notificaciones por correo</h5>
                        <p class="card-text">
