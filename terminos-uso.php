...
<section class="py-5 contenedor_principal">
    <div class="contenedor">
        ...
        <img src="img/contrato.png" alt="pluma-de-escribir" style="float: right; width: 30%;">
        <h4 class="titulo-tarjeta text-center">Terminos y Condiciones de Uso</h4>
        <hr>
        ...
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Objetivo de la plataforma</u></h4>
        ...
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Usuarios de la plataforma</u></h4>
            En Clíniko pueden registrarse los siguientes tipos de usuarios:
                <ul style = "list-style: none;">
                    ...
                    <li>Yambién existen administradores, sin embargo, este registro en la plataforma esta limitado al resto de administradores.</li>
                </ul>
                Cada usuario debe ser responsable de los datos e información que proporciona durante el registro y el uso de su cuenta en la plataforma.
        </p>
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Registro y cuenta de usuario</u></h4>
        ...
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Uso correcto de la plataforma</u></h4>
            ...
            <ul style = "list-style: none;">
                ...
                <li>No aportar información falsa.</li>
                <li>No intentar acceder a cuentas, datos o sistemas ajenos.</li>
                <li>No dañar o sobrecargar el funcionamiento de la web.</li>
            </ul>
            Clíniko se reserva el derecho de suspender o eliminar cuentas que incumplan estas normas.
        </p>
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Gestión de citas médicas</u></h4>
            <ul style = "list-style: none;">
                ...
                <li>Clíniko no se responsabiliza de las cancelaciones o modificaciones de citas.</li>
            </ul>
        </p>
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Valoracaiones y comentarios</u></h4>
            <ul style = "list-style: none;">
            ...
            Clíniko se reserva el derecho de poder modiciar o eliminar aquellas valoraciones que incumplan la normativa.
        </p>
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Responsabilidad</u></h4>
            Clíniko no garantiza la disponibilidad continua del servicio o no será responsable de:
            <ul style = "list-style: none;">
                <li>Interrupciones del sistema.</li>
                <li>Problemas derivadores al uso incorrecto de la plataforma.</li>
                <li>Información médica proporcionada por los profesionales.</li>
            </ul>
        </p>
        <p style="color: #333333; text-align: justify;">
        ...
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Modificaciones</u></h4>
            Clíniko se reserva el derecho de poder modificar estos términos y condiciones en cualquier momento.
        </p>
        <p style="color: #333333; text-align: justify;">
            <h4 class="titulo-tarjeta2"><u>Legislación aplicable</u></h4>
