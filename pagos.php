        ...
        <p class="descripcion-secundaria mt-3" style="color: #333333; text-align: justify;">
            ...
            <br><br>
                <ul style = "list-style: none;">
                    ...
                    <li>CActualmente no se aceptan otros métodos de pago como efectivo o transferencia. De esta manera, impulsamos la seguridad y la rapidez.</li>
                </ul>
            Creemos que el pago de tus citas ha de ser rápido y sencillo. Por eso, la plataforma está diseñada para que completes tus reservas en pocos pasos, sin necesidad
            de trámites complicados. La comprobación automática de pagos asegura que tu cita quede registrada de manera inmediata, y que tanto el paciente como el médico tengan acceso a la información solicitada.
        </p>
    </div>
</section>
