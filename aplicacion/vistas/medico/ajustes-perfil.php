                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 mb-4">
                            <form id="form-foto" method="POST" action="../../controladores/cambiar-foto-medico.php" enctype="multipart/form-data">
                                <fieldset class="border p-3 rounded borde-fieldset-ajustes-perfil">
                                    <legend class="font-weight-bold w-auto titulo-ajustes-perfil">Foto de Perfil</legend>
                        ...
                        <div class="col-12 mb-4">
                            <form id="form-correo" method="POST" action="../../controladores/cambiar-correo-medico.php">
                                <fieldset class="border p-3 rounded borde-fieldset-ajustes-perfil">
                                    <legend class="font-weight-bold w-auto titulo-ajustes-perfil">Correo Electrónico</legend>
                                    <div class="form-group">
                        ...
                        <div class="col-12 mb-4">
                            <form id="form-telef" method="POST" action="../../controladores/cambiar-telefono-medico.php">
                                <fieldset class="border p-3 rounded borde-fieldset-ajustes-perfil">
                                    <legend class="font-weight-bold w-auto titulo-ajustes-perfil">Teléfono</legend>
                                    <div class="form-group">
                        ...
                        <div class="col-12 mb-4">
                            <form id="form-contra" method="POST" action="../../controladores/cambiar-contrasena-medico.php">
                                <fieldset class="border p-3 rounded borde-fieldset-ajustes-perfil">
                                    <legend class="font-weight-bold w-auto titulo-ajustes-perfil">Contraseña</legend>
                                    <div class="form-group">
                        ...
                        <div class="col-12 mb-4">
                            <fieldset class="border p-3 rounded borde-fieldset-ajustes-perfil-eliminar">
                                ...
                                <p class='texto-eliminar'>Al eliminar tu cuenta, todos tus datos serán eliminados de manera permanente y no podrás volver a poder acceder a ella.</p>
                                <div class="text-right">
                                    <button type="button" class="btn boton-cuadrado-eliminar" onclick="confirmarEliminarCuenta()">Eliminar cuenta</button>
                                </div>
                            </fieldset>
                        </div>
                    </div>
