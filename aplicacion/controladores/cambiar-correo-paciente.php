...
require_once "../modelos/cambiar-correo-paciente-modelo.php";
session_start();

//VERIFICO QUE NO HAYA NINGÚN PROBLMA CON EL ID DEL PACIENTE
...
//PARA VER QUE EL CORREO NO VUELVA A SER EL MISMO
