...
<section class="seccion-que-es py-5">
    <div class="contenedor">
        ...
        <img src="img/como_se_usa.png" alt="candado" style="float: right; width: 30%;">
        <h1 class="titulo-principal text-center" style="color: #f0cb93ff;">Cómo funciona Clíniko</h1>
        ...
        <p class="descripcion-secundaria mt-3" style="color: #333333; text-align: justify;">
            <h4 style="color: #f0cb93ff;"><u>Cíniko para pacientes</u></h4>
            <ul style = "list-style: none;">
                    <li>Registro y perfil: crea tu cuenta como paciente proporcionando tus datos personales, información de contacto y una foto de perfil. Esto te permitirá
                        acceder al panel de usuario como paciente.
                    </li>
                    <li>Buscar médicos y especialidades: una vez registrado, podrás ver la lista de médicos disponibles, filtrarlos por especialdiad y consultar su información, como
                        su nombre, apellidos o especialidad.
                    </li>
        ...
        <hr></hr>
        <p class="descripcion-secundaria mt-3" style="color: #333333; text-align: justify;">
            <h4 style="color: #f0cb93ff;"><u>Cíniko para médicos</u></h4>
            Sin embargo, si eres médico:
            <br><br>
                <ul style = "list-style: none;">
                    <li>Registro y perfil profesional: los médicos crean su cuenta proporcionando datos profesionales como el número de colegiado y su especialidad.
                    </li>
                    <li>Gestión de citas: Podrán habilitar sus días y horarios dipsonibles para que los pacientes reserven citas. Desde su panel, también pueden ver todas las citas activas y pasadas y
                        añadir información al historial médico de los pacientes.
                    </li>
                    <li>Valoraciones y comentarios: podrán consultar las valoraciones que reciben de sus pacientes, ayduando a mejorar la atención y calidad del servicio.
                    </li>
        ...
        <hr></hr>
        <p class="descripcion-secundaria mt-3" style="color: #333333; text-align: justify;">
            <h4 style="color: #f0cb93ff;"><u>Seguridad y notificaciones</u></h4>
            <br><br>
        ...
        <hr></hr>
        <p class="descripcion-secundaria mt-3" style="color: #333333; text-align: justify;">
            <h4 style="color: #f0cb93ff;"><u>¿Por qué deberías unirte?</u></h4>
            <br><br>
            <ul style = "list-style: none;">
                    <li>Ahorras tiempo en la búsqueda de atención médica.
                    </li>
                    <li>Tienes un historial médico accesible.
                    </li>
                    <li>Proporcionamos una comunicación rápida y segura.
                    </li>
