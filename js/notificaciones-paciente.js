            ...
            if(respuesta.notificaciones.length === 0){
                ...
                respuesta.notificaciones.forEach(function(notificacion){
                    ...
                    if(notificacion.leida === "no"){
                        boton_leida = "<button class='btn btn-sm boton-leida mt-2 w-100' onclick='marcarLeida("+notificacion.id_notificacion+")'>¿Leída?</button>";
                    }
                                ...
                                "<div class='card-body'>"+
                                    "<div class='row align-items-center'>"+
                                        ...
                                        "<div class='col-md-7'>"+
                                            ...
                                            "<span class='fecha-notificacion'>"+fecha+" - "+hora+"</span>"+
                                        "</div>"+
...
//FUNCIÓN PARA MARCAR LA NOTIFICACIÓN COMO LEIDA
...
//SE CARGAN LAS NOTIFICAICONES AL CARGAR TODO EL DOM DE LA PÁGINA
