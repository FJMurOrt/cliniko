    ...
    peticion.onreadystatechange = function(){
        if(peticion.readyState === 4 && peticion.status === 200){
            ...
            if(respuesta.notificaciones.length === 0){
                informacion_de_la_notificacion = "<div class='col-12 text-center'><p style='color: #2C2C3E;'>No tienes notificaciones.</p></div>";
            }else{
                respuesta.notificaciones.forEach(function(notificacion){
                    ...
                    var boton_leida = "<button class='btn boton-cuadrado btn-sm mt-2' onclick='marcarLeida("+notificacion.id_notificacion+")'>¡Leída!</button>";
